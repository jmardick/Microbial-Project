...
set.seed(42)
tsne_result <- Rtsne(pca_input_unique, dims = 2, perplexity = 10, max_iter = 7000, verbose = TRUE, pca = FALSE, normalize = FALSE)
...
plot6 <- ggplot(tsne_df, aes(x = X, y = Y)) +
  ...
  theme_minimal() +
  labs(title = "t-SNE of Pure Isolate Principal Components", fill = "Genus", color = "Genus") +
