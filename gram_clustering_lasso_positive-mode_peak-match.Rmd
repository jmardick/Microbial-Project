...
subtitle: "Negative Mode Detection with Peak List"
...
sample_dir <- gsub("\\\\", "/", r"(C:\Users\Jacob\Box\Eberlin_Lab_BCM\Projects\Bacterial Identification\data\pos-neg_matched\Pure_Isolates\negative_mode)")
...
lasso_coef <- reportCoef(xall, model, cvmodel$lambda.min, filtered_mz, classes)
```
