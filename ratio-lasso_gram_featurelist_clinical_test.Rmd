...
model_path <- gsub("\\\\", "/", r"(C:\Users\Jacob\Box\Eberlin_Lab_BCM\Projects\Bacterial Identification\Jacob_scripts\ratio-lasso_gram_featurelist_2025-05-01\2025-05-01_11.29_ratio-lasso_gram_featurelist_files\2025-05-01_11.35_ratio-lasso_gram_featurelist_model.RData)")
...
compute_needed_ratios <- function(x, trained_features, min_valid = 1) {
...
save(list = ls(), file=file.path(files_dir, paste0(format(Sys.time(), "%Y-%m-%d_%H.%M"),"_", proj_name, "_.RData")))
```