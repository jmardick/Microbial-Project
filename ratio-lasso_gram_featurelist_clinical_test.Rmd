...
model_path <- gsub("\\\\", "/", r"(C:\Users\Jacob\OneDrive - Baylor College of Medicine\Documents\Manoj\Microbial-Project\outputs\ratio-lasso_gram_featurelist_2025-10-20\2025-10-20_15.13_ratio-lasso_gram_featurelist_files\2025-10-20_16.12_ratio-lasso_gram_featurelist_model.RData)")
...
```{r pca}
# Run PCA
xall1_filtered <- xall1[, apply(xall1, 2, function(col) sd(col) != 0)]
pca <- prcomp(xall1_filtered, center = TRUE, scale. = TRUE)
...
set.seed(42)
tsne_result <- Rtsne(pca_input_unique, dims = 2, perplexity = 3, max_iter = 1000, verbose = TRUE)
